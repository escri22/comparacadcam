	...
	<div class="container">
		<div class="home_blog_post">
			<div class="page_title_area pos_title">
				...
				<h2>{l s='Our ' mod='xipblogdisplayposts'}<span>{l s='Blog ' mod='xipblogdisplayposts'}</span>{l s='Posts' mod='xipblogdisplayposts'}</h2>
				<p>{l s='Do you want to present posts in the best way to highlight interesting moments of your blog?' mod='xipblogdisplayposts'}</p>
			</div>
