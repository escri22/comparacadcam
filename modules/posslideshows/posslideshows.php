        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1">Exclusive Offer -60% Off This Week</p>
					<p class="title2">CPU Gigabyte</p>
					<p class="title3">Sale 60% Off</p>
					<p class="title4">Starting at <span>$640.99</span></p>
					<p class="readmore"><a href="#">shopping Now</a></p>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc1 desc2">
					<p class="title1">Bestseller Products 2018 - 2019</p>
					<p class="title2">Awesome Deal!</p>
					<p class="title3">Gamepad Xbox</p>
					<p class="title4">Starting at <span>$120.99</span></p>
					<p class="readmore"><a href="#">shopping Now</a></p>
					</div>';
				}
