			...
			{if $title}
				<div class="pos_title">
					 <h2>
						...
						{l s='New' mod='posnewproducts'}<span>{l s='Collections' mod='posnewproducts'}</span>{l s='Of Arrivals' mod='posnewproducts'}
					</h2>
					<p>{l s='Browse the collection of our new products, You will definitely find what you are looking for.' mod='posnewproducts'}</p>
