...
class Contactform extends Module implements WidgetInterface
{
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        $this->contact['namecompany'] = trim(Tools::getValue('namecompany'));
    ...
    {
        //mail("seopedro@gmail.com",'in sendMessage: ', print_r('',true));
        $extension = array('.txt', '.rtf', '.doc', '.docx', '.pdf', '.zip', '.png', '.jpeg', '.gif', '.jpg');
        $file_attachment = Tools::fileAttachment('fileUpload');
        $message = trim(Tools::getValue('message'));
        $namecompany = trim(Tools::getValue('namecompany'));
        ...
        //mail("seopedro@gmail.com",'$namecompany', print_r($namecompany,true));
        ...
        if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
        ...
        } elseif (empty($namecompany)) {
            $this->context->controller->errors[] = $this->trans(
                'The namecompany cannot be blank.',
                [],
                'Shop.Notifications.Error'
            );
            ...
            //mail("seopedro@gmail.com",'errors: '.count($this->context->controller->errors), print_r('',true));
